...
class Plugin(chatMod.chatMod):
	""" generates x {bm} random numbers of y {bf}  given range  """
	...
	def start(self):
		...
		self.kcs=["lotto", "lotte","loter","ellot"]
		#TODO setting (language) key from here?
	@callback
	def command(self, user, channel, command, options):
		if command.lower()[0:5] in self.kcs and options != "":
