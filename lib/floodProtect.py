...
###################################################################################################
    ...
    ###################################################################################################
    """ 
    below functions are representing a source file parser for building the kcs at all-
    once builded and saved to floodprotection.config, only "new" commands from source will be appended
    """
